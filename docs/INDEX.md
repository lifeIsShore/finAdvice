...
Welcome to the **FinAdvice** documentation! This index helps you find exactly what you need.
...
2. **Review logs** - `algotrade_datascience/data_pipeline.log`
3. **Check quality report** - `algotrade_datascience/data/quality_report.json`
